...
GameWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10GameWindowE_t>() {
  namespace QMC = QtMocConstants;
  QtMocHelpers::StringRefStorage qt_stringData{"GameWindow", "updateGame", ""};
  ...
  return QtMocHelpers::metaObjectData<GameWindow,
                                      qt_meta_tag_ZN10GameWindowE_t>(
...
void GameWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id,
                                    void **_a) {
...
void *GameWindow::qt_metacast(const char *_clname) {
  ...
  if (!strcmp(
          _clname,
          qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10GameWindowE_t>.strings))
